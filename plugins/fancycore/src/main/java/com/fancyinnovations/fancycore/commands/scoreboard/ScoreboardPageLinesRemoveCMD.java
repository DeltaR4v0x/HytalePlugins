...
public class ScoreboardPageLinesRemoveCMD extends AbstractPlayerCommand {
    ...
    public ScoreboardPageLinesRemoveCMD() {
        super("remove", "Remove a line from a scoreboard page");
        requirePermission("fancycore.commands.scoreboard.page.lines.remove");
    }
    ...
    protected void execute(@NotNull CommandContext ctx, @NotNull Store<EntityStore> store, @NotNull Ref<EntityStore> ref, @NotNull PlayerRef playerRef, @NotNull World world) {
        ...
        fp.sendMessage("Removed line " + lineNumber + " from scoreboard page '" + page.getName() + "': " + line.getContent());
    }
}
